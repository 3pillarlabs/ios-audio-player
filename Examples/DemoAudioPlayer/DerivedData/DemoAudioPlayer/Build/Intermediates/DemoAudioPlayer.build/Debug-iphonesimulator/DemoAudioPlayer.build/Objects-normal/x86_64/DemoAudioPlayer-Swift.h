...
SWIFT_CLASS("_TtC15DemoAudioPlayer11AppDelegate")
...
SWIFT_CLASS("_TtC15DemoAudioPlayer14ViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified fastforwardButton;
...
- (IBAction)rewindButtonPressed:(id _Nonnull)sender;
- (IBAction)fastforwardButtonPressed:(id _Nonnull)sender;
- (IBAction)sliderValueChanged:(UISlider * _Nonnull)sender;
- (void)updatePlayButton;
- (void)setupSlider;
- (void)sliderTimerTriggered;
- (void)updateCurrentTimeLabel:(float)currentTimeInSeconds;
- (void)setupTotalTimeLabel;
- (void)showLoadingIndicator;
- (void)hideLoadingIndicator;
- (NSString * _Nonnull)timeLabelString:(NSInteger)duration;
